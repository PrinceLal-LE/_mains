...
@section('title', 'SCG | Contact Us')

@section('content')

<section class="mb-32">
    <div>
        <img src="{{ asset('images/contact_us.png') }}" class="h-[300px] w-[100%]" alt="">
    </div>
    <div id="map"
        class="relative h-[300px] overflow-hidden bg-cover bg-[50%] bg-no-repeat justify-center items-center flex mt-6">
        <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d517.2977415374536!2d82.57305082631926!3d25.149362094937626!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x398fc1cd85f72fa5%3A0x139b173277e0c43f!2sPadarath%20Lal%20Ki%20Gali%2C%20Wellesley%20Ganj%2C%20Mirzapur%2C%20Mirzapur-cum-Vindhyachal%2C%20Uttar%20Pradesh%20231001!5e0!3m2!1sen!2sin!4v1753555559816!5m2!1sen!2sin"
            width="75%" height="300" style="border:0;" allowfullscreen="" loading="lazy"
            referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
    <div class="container-fluid px-6 md:px-12 mx-100">
        <div
