<nav class="fixed top-0 left-0 w-full h-20 grid place-items-center z-50 transition-all bg-[#003347]">
  <div class="container mx-auto flex justify-between items-center h-full px-6">
    ...
    <a href="{{ route('index') }}" class="flex items-center">
      <img src="{{ asset ('images/favicon.ico') }}" alt="nav logo" class="object-cover object-center">
      <span id="companyName" class="text-white text-3xl">Sagar Construction Group</span>
    </a>

    <!-- NAV LINKS -->
    <ul class="hidden lg:flex gap-16 text-white">
      <li><a href="{{ route('index') }}"
          class="hover:text-[#ff7b02] transition-colors {{ Route::is('index') ? 'text-yellow-400 underline' : 'text-white' }}">Home</a>
      </li>
      <li><a href="{{ route('about') }}"
          class="hover:text-[#ff7b02] transition-colors {{ Route::is('about') ? 'text-yellow-400 underline' : 'text-white' }}">About</a>
      </li>
      ...
      <li><a href="{{ route('career') }}"
          class="hover:text-[#ff7b02] transition-colors {{ Route::is('career') ? 'text-yellow-400 underline' : 'text-white' }}">Career</a>
      </li>
    </ul>
    ...
    <ul class="hidden lg:flex gap-4">
      <li>
        <a href="#" target="_blank"
          ...
          <svg class="transition-all duration-300 group-hover:scale-110" width="28" height="28" viewBox="0 0 72 72"
      ...
      <li>
        <a href="#" target="_blank"
          ...
          <svg class="transition-all duration-300 group-hover:scale-110" xmlns="http://www.w3.org/2000/svg" width="28"
      ...
      <li>
        <a href="#" target="_blank"
          ...
          <svg class="rounded-md transition-all duration-300 group-hover:scale-110" xmlns="http://www.w3.org/2000/svg"
            width="28" height="28" viewBox="0 0 72 72" fill="none">
            <path
...
<ul class="absolute top-[4rem] right-0  text-white flex-col hidden lg:hidden w-48 shadow-lg" id="mobile-nav">
  <li
    ...
    <a href="{{ route('index') }}" class="flex items-center h-full px-6">Home</a>
  </li>
  <li
    class="h-20 shadow-[-3rem_3rem_3rem_rgba(0,0,0,0.7)] bg-[#003347] hover:bg-[#003347]/80 animate-navAnimation [animation-delay:200ms]">
    <a href="{{ route('about') }}" class="flex items-center h-full px-6">About</a>
  </li>
  <li
  ...
  <li
    ...
    <a href="{{ route('contact') }}" class="flex items-center h-full px-6">Contact Us</a>
  </li>
  <li
    class="h-20 shadow-[-3rem_3rem_3rem_rgba(0,0,0,0.7)] bg-[#003347] hover:bg-[#003347]/80 animate-navAnimation [animation-delay:600ms]">
    <a href="{{ route('career') }}" class="flex items-center h-full px-6">Career</a>
  </li>
</ul>
<!-- End Of Nav -->